...
REAL_MONGO_DB_NAME: str = os.getenv("MONGO_REAL_DB_NAME")
TEST_MONGO_DB_NAME: str = os.getenv("MONGO_TEST_DB_NAME")
...
# MongoDB cloud
MONGO_DB_CLOUD_URL: str = os.getenv("MONGO_URL_CLOUD")
